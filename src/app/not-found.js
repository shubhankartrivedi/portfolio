...
export default async function NotFound() {
    ...
    const res = await fetch('https://api.thecatapi.com/v1/images/search?limit=1', { next: {
      revalidate: 10,
    } })
    ...
    return (
        <div className="px-10 py-28 flex flex-col justify-center items-center gap-10">
            ...
            <div className="flex flex-col justify-center">
                ...
                <div className="flex flex-row justify-center relative">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <caption className="drop-shadow-lg italic text-right w-full dark:text-gray-600 text-gray-400 animate-fade-in">from <Link href='https://thecatapi.com' target="blank" className="underline hover:no-underline">thecatapi.com</Link></caption>
                    </div>
