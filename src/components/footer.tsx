...
export default function Footer() {
  return (
    <footer className="mb-16 border-t dark:border-white/20 border-black/20">
      <ul className="font-sm mt-8 text-neutral-600 flex gap-4 dark:text-neutral-300">
        ...
        <li>
          <Link
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://instagram.com/devshubhankar"
          >
      ...
      <p className="mt-8 text-neutral-600 dark:text-neutral-300">
        © {new Date().getFullYear()} Shubhankar Trivedi
      </p>
    </footer>
  )
}
